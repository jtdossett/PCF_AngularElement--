...
import './../PCFAngularElement/dist/pcfangular-element/bundle';
...
export class PCFAngularElementComponent implements ComponentFramework.StandardControl<IInputs, IOutputs> {
     ...
     * @param container If a control is marked control-type='standard', it will receivxe an empty div element within which it can render its content.
     */
